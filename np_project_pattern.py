...
def uri_split(uri,sender_email):
    ...
    if(uri_all[0] == 'mailto'):
        ...
        lable_success = Label(webTab, text='Email already send, please check to your mail sent section')
        lable_success.grid(column=1, row=_)  
        messagebox.showinfo("Email Sending Success!", 'Email already send, please check to your mail sent section') 
